...
Handlebars.VM = {
  ...
  invokePartial: function(partial, name, context, helpers, partials, data, resolver, mode) {
    ...
    if(partial === undefined) {
      ...
      // If we have a mode, replace the generic name with the mode-specific
      // name so our caches don't clobber each other between modes
      if (mode) {
        name = name.replace('framework', mode);
      }
